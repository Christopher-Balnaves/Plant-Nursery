			...
			if (answer=="Yes") {
				...
				if (answer=="Yes") {
					...
					if (job=="Clerk") {
						...
						people.push_back(new GardenHand(name,inventory.size()));
					} else {
						cout << "Error." << endl;
					}
					...
					if (job=="Clerk") {
						...
						people.push_back(new GardenHand(inventory.size()));
					}
				} else {
				...
				//To create a person with unknown job and details
			} else if (answer=="No") {
